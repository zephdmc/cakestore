        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-pink-700 py-8">
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center py-12">
                    ...
                    <p className="text-white/80 text-lg">Loading delicious cakes...</p>
                </div>
            </div>
        </div>
    );
                ...
                >
                    <div>
                        ...
                        <p className="text-white/70">
                            Discover our handcrafted collection of beautiful and tasty creations
                        </p>
                    </div>
                        ...
                        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-12 max-w-2xl mx-auto">
                            ...
                            <p className="text-white/70 mb-8 max-w-md mx-auto">
                                {searchQuery 
                                    ...
                                    : 'No products match your current filter criteria. Try clearing filters to see all available products.'
                                }
                            </p>
